...
Launch the [`make.R`](https://github.com/GBarnsley/mortality-estimation/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/GBarnsley/mortality-estimation/blob/main/CONTRIBUTING.md).
